...
import (
	"fmt"
	go_token_generator "github.com/arief-hidayat/go-token-generator"
...
func main() {
	...
	token := go_token_generator.NewCustomTokenSingleSecret(cfg.KeyId, cfg.Key)

	tokenPolicy := go_token_generator.DefaultTokenPolicy()
	...
	viewerAttrs := &go_token_generator.ViewerAttributes{
		Country: cfg.Country,
		Region:  cfg.Region,
